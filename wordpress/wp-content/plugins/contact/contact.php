...
function example_form_capture()
{
    if(isset($_POST['name_an'], $_POST['email_an'], $_POST['subject'], $_POST['comments_an']))
    {
        ...
        if ($valid) {
            ...
            global $wpdb;
            send_admin_notification($name, $email, $subject, $comments);
...
function send_admin_notification($name, $email, $subject, $comments) {
    $to = 'soufianeargane800@gmail.com'; // Change this to the email address you want to receive the notification
